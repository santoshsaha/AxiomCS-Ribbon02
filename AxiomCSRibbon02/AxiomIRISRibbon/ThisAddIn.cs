    ...
    public partial class ThisAddIn
    {
        ...
        private void ThisAddIn_Startup(object sender, System.EventArgs e)
        {
            ...
            if (autologin && _localSettings.Debug)
            {
                ...
                // string rtn = _d.Login("demo@salesorg.com", "Password", "Token", "https://login.salesforce.com", "AutoLogin - Sales");

                //string rtn = _d.Login("demo@salesorg.com", "Axiomlaw5", "3RtdsztAVZo1WzOMJ8hW3OX9", "https://login.salesforce.com", "AutoLogin - Sales");

                string rtn = _d.Login("russel.mcneill@cs.com.rksb1", "LargeTreesCollide123", "0gyx7Rl3FIU5DPFmADR07VwXw", "https://test.salesforce.com", "AutoLogin - CSDev");
       ...
       public ContractEdit.SForceEditSideBar2 GetTaskPaneControlContract(Word.Document doc)
        ...
        {
            // Remove the handler - otherwise when we select the element it fires and makes it readonly and we can't delete
            doc.ContentControlOnExit += new Word.DocumentEvents2_ContentControlOnExitEventHandler(vstoDoc_ContentControlOnExit);
